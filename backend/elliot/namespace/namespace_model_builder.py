...
class NameSpaceBuilder(Builder):
    ...
    def base_evaluation(self) -> NameSpaceModel:
        namespace = self._namespace
        namespace.fill_base_evaluation()
        return namespace

    @property
    def base_recommendation(self) -> NameSpaceModel:
        namespace = self._namespace
        namespace.fill_base_recommendation()
        return namespace

    def models(self) -> tuple:
        return self._namespace.fill_model()

    def proxy_recommender(self):
        return self._namespace.fill_proxy()